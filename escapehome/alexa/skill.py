...
from alexa.request_handler.intents.navigate_menu import navigate_menu_request
...
def in_progress_choose_sceanrio_intent_handler(handler_input):
    return in_progress_choose_sceanrio_request(handler_input, MINUS_POINTS)
...
def cancel_and_stop_intent_handler(handler_input):
    ...
    return cancel_and_stop_request(handler_input)
